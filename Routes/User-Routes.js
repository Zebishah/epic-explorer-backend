...
UserRoutes.post("/extraPaymentDetail", extraPaymentDetail);

UserRoutes.post("/extraTPaymentDetail", extraPaymentDetailTransport);

UserRoutes.post("/extraHPaymentDetail", extraHPaymentDetailTransport);
